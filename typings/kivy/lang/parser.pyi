...
class ParserRuleProperty:
    ...
    @classmethod
    def get_names_from_expression(cls, node): # -> Generator[_Identifier | Unknown, Unknown, None]:
        """
...
class Parser:
    ...
    def parse_level(self, level, lines, spaces=...): # -> tuple[list[Unknown], Unknown] | tuple[list[Unknown], list[Unknown]]:
...
class ParserSelectorName(ParserSelector):
    parents = ...
    def get_bases(self, cls): # -> Generator[Unknown, Any, None]:
        ...
