...
class WindowBase(EventDispatcher):
    ...
    left = ...
    @property
    def __self__(self): # -> Self@WindowBase:
        ...
    ...
    def to_widget(self, x, y, initial=..., relative=...): # -> tuple[Unknown, Unknown]:
        ...
    
    def to_window(self, x, y, initial=..., relative=...): # -> tuple[Unknown, Unknown]:
        ...
    
    def to_normalized_pos(self, x, y): # -> tuple[Unknown | float, Unknown | float]:
    ...
    def get_root_window(self): # -> Self@WindowBase:
        ...
    
    def get_parent_window(self): # -> Self@WindowBase:
        ...
