...
class ImageData:
    ...
    def iterate_mipmaps(self): # -> Generator[tuple[int, Unknown, Unknown, Unknown, Unknown], Any, None]:
...
class Image(EventDispatcher):
    ...
    @property
    def size(self): # -> list[int] | Any | tuple[Any | Unknown | int, Any | Unknown | int]:
        '''Image size (width, height)
        '''
        ...
    ...
    @property
    def texture(self): # -> Unknown | Any | Image | None:
