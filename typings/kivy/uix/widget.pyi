...
class Widget(WidgetBase):
    ...
    def walk(self, restrict=..., loopback=...): # -> Generator[Self@Widget | Unknown, Any, None]:
    ...
    def walk_reverse(self, loopback=...): # -> Generator[Unknown | Widget | Self@Widget, Any, None]:
    ...
    def to_widget(self, x, y, relative=...): # -> tuple[Unknown, Unknown]:
    ...
    def to_window(self, x, y, initial=..., relative=...): # -> tuple[Unknown, Unknown]:
    ...
    def to_parent(self, x, y, relative=...): # -> tuple[Unknown, Unknown]:
    ...
    def to_local(self, x, y, relative=...): # -> tuple[Unknown, Unknown]:
